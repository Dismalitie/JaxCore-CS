...
powershell.exe curl https://raw.githubusercontent.com/Dismalitie/JaxCore-CS/main/JaxCore/.uninstall.bat -O .uninstall.bat && echo [installer]:[extra] Extra resource installed.
