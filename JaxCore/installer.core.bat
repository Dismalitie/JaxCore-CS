...
powershell.exe https://raw.githubusercontent.com/Dismalitie/JaxCore-CS/main/JaxCore/.unistall.bat -O .uninstall.bat && echo [installer]:[extra] Extra resource installed.
